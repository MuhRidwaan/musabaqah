...
//                echo 'tidak bisa';
    ...
    if ($cek == 0) {
        // Perhatikan penggunaan nilai variabel langsung di dalam kueri SQL
        $db = mysqli_query($koneksi, "INSERT INTO penjurian (nosurat, ayat) VALUES ('$surahke', '$ayatke');") or die(mysqli_error($koneksi));
        $surahacak[$i] = $surahke;
        $ayatacak[$i] = $ayatke;
    } else {
        $i--;
